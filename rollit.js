...
rollup.rollup({
    ...
    let b = bundle.write({
        dest: 'dist/dom-selection-off.js',
        format: 'iife',
        sourceMap: true,
        moduleName: 'freeLine'
    });
    ...
    b.then(what=>{
        ...
        try{
            var result = UglifyJS.minify('dist/dom-selection-off.js');
            //console.log('result ',result)
            writeFile('dist/dom-selection-off.min.js', result.code, onErrorCB('minify'));
        }catch(e){
